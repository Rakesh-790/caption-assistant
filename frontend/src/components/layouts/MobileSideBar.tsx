...
function MobileSidebar({
  ...
  return (
    <>
      ...
      <aside
        className={`
          fixed top-0 left-0 h-full w-64 bg-white dark:bg-zinc-900 border-r border-zinc-200 dark:border-zinc-800 z-50
        ...
        <div className="flex flex-col justify-between h-full">
          ...
          <div className="p-4 border-t border-zinc-200 dark:border-zinc-800">
            ...
            <button
              ...
              hover:bg-zinc-100 dark:hover:bg-zinc-800 hover:text-zinc-900 dark:hover:text-white transition-colors 
              duration-200"
            >
              <LogOut size={20} />
